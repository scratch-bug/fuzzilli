        ...
        for (let v9 = 0; v9 < 5; v9++) {
            function f10(a11, a12, a13) {
                const v14 = `
                    function f15(a16, a17) {
                        const v45 = {
                            get d() {
                                ...
                                let v31;
                                try { v31 = Worker(f20); } catch (e) {}
                                function F32(a34, a35) {
                                    if (!new.target) { throw 'must be called with new'; }
                                }
                                try { F32(f15, v31); } catch (e) {}
                                try { Intl.style = Intl; } catch (e) {}
                                Intl?.DisplayNames;
                                try { new Int16Array(228); } catch (e) {}
                                h = v9;
                                %VerifyType(a17);
                                a16 <= F0 ? a16 : F0;
                                return v29;
                    ...
                    try { f15(WeakSet, v9); } catch (e) {}
                    try { f15(a8, Promise); } catch (e) {}
                    try { f15(F0, v9); } catch (e) {}
                    try { f15(F0, 128); } catch (e) {}
                    [-4294967297];
                    function F51() {
                        if (!new.target) { throw 'must be called with new'; }
                    }
